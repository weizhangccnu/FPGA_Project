...
.WR_DATA1("open"),                      //second byte data for write
.RD_DATA0("open"),                      //first byte readout
.RD_DATA1("open"),                      //second byte readout
.BUSY("open"),                          //indicates transaction in progress
.SDA_in("open"),                        //serial data input of i2c bus
...
//assign SDA_OUT = clk_25MHz;
//assign SCL = clk_25MHz;
//---------------------------------------------------------> IIC
endmodule
